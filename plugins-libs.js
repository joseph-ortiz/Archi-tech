...
(function(e) {
    ...
    C.prototype = {
        ...
        open: function(i) {
            if (!t.isOpen) {
                var r;
                if (t.types = [], o = "", t.ev = i.el || a, i.isObj) t.index = i.index || 0;
                else {
                    t.index = 0;
                    var s, l = i.items;
        ...
        proto: {
            initInline: function() {
                t.types.push(S), P = !1, w(l + "." + S, function() {
                    ...
                    if (e.type === S) {
                        if (P)
                            for (var i = 0; t.items.length > i; i++) e = t.items[i], e && e.inlinePlaceholder && e.inlinePlaceholder.after(e.inlineElement.addClass(t.st.inline.hiddenClass)).detach();
            ...
            initGallery: function() {
                ...
                return t.direction = !0, i && i.enabled ? (o += " mfp-gallery", w(u + n, function() {
                    ...
                    if (t._preloadTimeout && clearTimeout(t._preloadTimeout), t._preloadTimeout = setTimeout(function() {
                        ...
                        var n = i.arrowMarkup,
                            a = t.arrowLeft = e(n.replace("%title%", i.tPrev).replace("%dir%", "left")).addClass(h),
                            o = t.arrowRight = e(n.replace("%title%", i.tNext).replace("%dir%", "right")).addClass(h),
